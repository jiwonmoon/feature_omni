...
namespace F_test
{
	...
	protected:
		...
		void ComputeKeyPointsOctTree(std::vector<std::vector<cv::KeyPoint>>& allKeypoints, std::vector<cv::Mat> masks, const cv::Mat LUT_x, const cv::Mat LUT_y, const cv::Mat LUT_x_inv, const cv::Mat LUT_y_inv);
